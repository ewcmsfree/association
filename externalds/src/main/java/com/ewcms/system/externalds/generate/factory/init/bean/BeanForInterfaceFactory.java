package com.ewcms.system.externalds.generate.factory.init.bean;
 ...
 */
@Component
public class BeanForInterfaceFactory implements ApplicationContextAware {
    ...
    public Object getBean(Map classToBeanMappings, Class _class) {
        ...
        if (beanName == null) {
            ...
            throw new BaseException("名称未找到接口", new Object[]{_class.getName()});
        }
        ...
        if (bean == null) {
            ...
            throw new BaseException("Bean没有名字", new Object[]{beanName});
        }
