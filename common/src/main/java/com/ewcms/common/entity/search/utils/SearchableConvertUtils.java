package com.ewcms.common.entity.search.utils;

import com.ewcms.common.entity.search.Searchable;
import com.ewcms.common.entity.search.exception.InvalidSearchPropertyException;
import com.ewcms.common.entity.search.exception.InvalidSearchValueException;
...
public final class SearchableConvertUtils {
	...
	private static void convert(BeanWrapperImpl beanWrapper, Condition condition) {
        ...
        if (isCollection || isArray) {
            ...
            //查询属性中含有不含有‘|’时，转换成集合对象
            if (condition.getSearchProperty().indexOf("|") == -1){
