 ...
 * @author wu_zhijun
 */
public abstract class BaseMovableService<M extends BaseSequenceEntity<ID> & Movable, ID extends Serializable> extends BaseService<M, ID> {
	...
	public void reweight() {
        ...
        do {
            ...
            ((BaseMovableService<M, ID>) AopContext.currentProxy()).doReweight(page);
    ...
    public M findPreByWeight(Integer weight) {
        ...
        searchParams.put("LE_weight", weight);
        Sort sort = new Sort(Sort.Direction.DESC, "weight");
    ...
    public M findNextByWeight(Integer weight) {
        ...
        Map<String, Object> searchParams = Maps.newHashMap();
        searchParams.put("GT_weight", weight);
    ...
    private Long countByBetween(Integer minWeight, Integer maxWeight) {
        Map<String, Object> searchParams = Maps.newHashMap();
        searchParams.put("GTE_weight", minWeight);
        searchParams.put("LTE_weight", maxWeight);
