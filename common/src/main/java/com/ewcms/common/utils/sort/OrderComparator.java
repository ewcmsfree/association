package com.ewcms.common.utils.sort;
 ...
 * @param <M>
 */
public class OrderComparator<M, S> implements Comparator<M> {
	private final String fieldName;
	
	private String str1, str2;
	private int pos1, pos2, len1, len2;

	public OrderComparator(S fieldName){
		this.fieldName = (String) fieldName;
	}
	
	public int compare(M o1, M o2) {
		str1 = (String) Reflections.getFieldValue(o1, (String)fieldName);
		str2 = (String) Reflections.getFieldValue(o2, (String)fieldName);
