...
import com.ewcms.common.utils.html.jsoup.EwcmsCleaner;
import com.ewcms.common.utils.html.jsoup.EwcmsWhitelist;
...
public class HtmlUtils {
    ...
    public static String removeUnSafeTag(String html) {
        EwcmsWhitelist whitelist = new EwcmsWhitelist();
        ...
        EwcmsCleaner cleaner = new EwcmsCleaner(whitelist);
