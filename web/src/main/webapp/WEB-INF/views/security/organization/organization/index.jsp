...
<ewcms:head title="组织机构 - 组织"/>
    <div class="easyui-layout" data-options="fit:true">
		...
		<div data-options="region:'center'" style="overflow:hidden;">
			<iframe id="editifr" name="editifr" class="editifr" width="100%" src="${ctx}/security/organization/organization/description"></iframe>
		</div>
	</div>
<ewcms:footer/>
...
<script type="text/javascript">
	...
	$(function(){
		_tree.init({
			baseUrl : '${ctx}/security/organization/organization/'
		});
	});
</script>
