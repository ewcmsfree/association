...
<ewcms:head/>
	<table id="tt" class="easyui-datagrid" data-options="toolbar:'#tb',fit:true,url:'${ctx}/security/permission/permission/query',nowrap:true,pagination:true,rownumbers:true,striped:true,pageSize:20,fitColumns:true">
		<thead>
			<tr>
			    <th data-options="field:'ck',checkbox:true"></th>
			    <th data-options="field:'id',hidden:true">编号</th>
				<th data-options="field:'name',width:150,sortable:true">权限名称</th>
				<th data-options="field:'permission',width:300,sortable:true">权限标识</th>
        	...
        	<form id="queryform" style="padding:0;margin:0;">
        		<table class="formtable">
              		<tr>
    					...
    					<td width="6%">权限标识：</td>
    					<td width="19%"><input type="text" name="LIKE_permission" style="width:120px"/></td>
    					<td width="6%">状态：</td>
    					<td width="19%">
